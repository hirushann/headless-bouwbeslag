      ...
      <div className="max-w-[1440px] mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-20">
          <FadeIn delay={0.2} className="bg-white p-8 rounded-sm shadow-sm flex flex-col items-start gap-4 h-full">
            <div className="bg-[#E6F0FF] p-3 rounded-full text-[#0050D1]">
            ...
            <div>
              ...
              <a href="mailto:contact@bouwbeslag.nl" className="text-[#0050D1] font-semibold hover:underline">contact@bouwbeslag.nl</a>
            </div>
          </FadeIn>
          ...
          <FadeIn delay={0.3} className="bg-white p-8 rounded-sm shadow-sm flex flex-col items-start gap-4 h-full">
            ...
            <div>
              ...
              <a href="tel:0031578760508" className="text-[#0050D1] font-semibold hover:underline">0578-760508</a>
            </div>
          </FadeIn>
           ...
           <FadeIn delay={0.4} className="bg-white p-8 rounded-sm shadow-sm flex flex-col items-start gap-4 h-full">
            ...
            <div>
              ...
              {/* <Link href="/faq" className="text-[#0050D1] font-semibold hover:underline">Bekijk FAQ</Link> */}
            </div>
          </FadeIn>
        </div>
      </div>
