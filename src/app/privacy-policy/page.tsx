...
export default function PrivacyPolicyPage() {
  return (
    <main className="max-w-[1440px] mx-auto px-5 lg:px-0 py-10 lg:py-20">
      <h1 className="text-3xl lg:text-4xl font-bold mb-6 text-[#1C2630]">Privacybeleid Dayz Solutions</h1>
      ...
      <div className="prose max-w-none text-[#1C2630]">
        ...
        <h2 className="text-2xl font-semibold mt-8 mb-4">Over ons privacybeleid</h2>
        
        <p className="mb-4">
          Dayz Solutions geeft veel om uw privacy. Wij verwerken daarom uitsluitend gegevens die wij nodig hebben voor (het verbeteren van) onze dienstverlening en gaan zorgvuldig om met de informatie die wij over u en uw gebruik van onze diensten hebben verzameld. Wij stellen uw gegevens nooit voor commerciële doelstellingen ter beschikking aan derden.
        </p>
        <p className="mb-4">
          Dit privacybeleid is van toepassing op het gebruik van de website en de daarop ontsloten dienstverlening van Dayz Solutions. De ingangsdatum voor de geldigheid van deze voorwaarden is 28/01/2026, met het publiceren van een nieuwe versie vervalt de geldigheid van alle voorgaande versies. Dit privacybeleid beschrijft welke gegevens over u door ons worden verzameld, waar deze gegevens voor worden gebruikt en met wie en onder welke voorwaarden deze gegevens eventueel met derden kunnen worden gedeeld. Ook leggen wij aan u uit op welke wijze wij uw gegevens opslaan en hoe wij uw gegevens tegen misbruik beschermen en welke rechten u heeft met betrekking tot de door u aan ons verstrekte persoonsgegevens.
        </p>
        <p className="mb-4">
        ...
        <h3 className="text-xl font-semibold mt-6 mb-2">Webwinkelsoftware</h3>
        <h4 className="text-lg font-semibold mt-4 mb-2">MijnWebwinkel</h4>
        ...
        <h3 className="text-xl font-semibold mt-6 mb-2">Office365</h3>
        <p className="mb-4">
        ...
        <h4 className="text-lg font-semibold mt-4 mb-2">Mollie</h4>
        <p className="mb-4">
        ...
        <h3 className="text-xl font-semibold mt-6 mb-2">Beoordelingen</h3>
        <h4 className="text-lg font-semibold mt-4 mb-2">WebwinkelKeur</h4>
        <p className="mb-4">
        ...
        <h3 className="text-xl font-semibold mt-6 mb-2">Verzenden en logistiek</h3>
        <h4 className="text-lg font-semibold mt-4 mb-2">GLS</h4>
        <p className="mb-4">
        ...
        <h3 className="text-xl font-semibold mt-6 mb-2">Facturatie en boekhouden</h3>
        <h4 className="text-lg font-semibold mt-4 mb-2">MoneyBird</h4>
        <p className="mb-4">
        ...
        <h3 className="text-xl font-semibold mt-6 mb-2">Externe verkoopkanalen</h3>
        <h4 className="text-lg font-semibold mt-4 mb-2">Bol.com</h4>
        <p className="mb-4">
        ...
        <h3 className="text-xl font-semibold mt-6 mb-2">Automatisch verzamelde gegevens</h3>
        <p className="mb-4">
        ...
        <h3 className="text-xl font-semibold mt-6 mb-2">Medewerking aan fiscaal en strafrechtelijk onderzoek</h3>
        <p className="mb-4">
          In voorkomende gevallen kan Dayz Solutions op grond van een wettelijke verplichting worden gehouden tot het
        ...
        <h3 className="text-xl font-semibold mt-6 mb-2">Bewaartermijnen</h3>
        <p className="mb-4">
        ...
        <h3 className="text-xl font-semibold mt-6 mb-2">Inzagerecht</h3>
        <p className="mb-4">
        ...
        <h3 className="text-xl font-semibold mt-6 mb-2">Rectificatierecht</h3>
        <p className="mb-4">
          U heeft altijd het recht om de gegevens die wij (laten) verwerken en die betrekking hebben op uw persoon of
        ...
        <h3 className="text-xl font-semibold mt-6 mb-2">Recht op beperking van de verwerking</h3>
        <p className="mb-4">
        ...
        <h3 className="text-xl font-semibold mt-6 mb-2">Recht op overdraagbaarheid</h3>
        <p className="mb-4">
          U heeft altijd het recht om de gegevens die wij (laten) verwerken en die betrekking hebben op uw persoon of
        ...
        <h3 className="text-xl font-semibold mt-6 mb-2">Recht van bezwaar en overige rechten</h3>
        <p className="mb-4">
          U heeft in voorkomende gevallen het recht bezwaar te maken tegen de verwerking van uw persoonsgegevens
          door of in opdracht van Dayz Solutions. Als u bezwaar maakt zullen wij onmiddellijk de gegevensverwerking
        ...
        <h3 className="text-xl font-semibold mt-6 mb-2">Cookies van derde partijen</h3>
        <p className="mb-4">
