        ...
        <FadeIn delay={0.3}>
          <section className="py-8 border-b border-[#DBE3EA]">
            ...
            <div className="bg-white border border-[#DBE3EA] rounded-sm p-6 my-6 shadow-[0px_10px_15px_0px_#0000000A] text-lg text-[#3D4752] leading-relaxed">
              <strong className="text-[#0050D1] font-semibold">Artitec Wallenbroek</strong> &middot; <strong className="text-[#0050D1] font-semibold">Mi Satori</strong> &middot; <strong className="text-[#0050D1] font-semibold">JNF</strong> &middot; <strong className="text-[#0050D1] font-semibold">Giesse</strong> &middot; <strong className="text-[#0050D1] font-semibold">Winlock</strong> &middot; <strong className="text-[#0050D1] font-semibold">Frank Allart</strong> &middot; <strong className="text-[#0050D1] font-semibold">HABO</strong> &middot; <strong className="text-[#0050D1] font-semibold">HAKO</strong> &middot; <strong className="text-[#0050D1] font-semibold">GPF Bouwbeslag</strong> &middot; <strong className="text-[#0050D1] font-semibold">SWF (Steel Window Fittings)</strong> &middot; <strong className="text-[#0050D1] font-semibold">Zoo Hardware</strong> &middot; <strong className="text-[#0050D1] font-semibold">Q-Lon</strong> &middot; <strong className="text-[#0050D1] font-semibold">Schlegel borstel</strong>
            </div>
            <p className="text-[#3D4752] text-base mb-4 leading-relaxed">
