...
export default function CategoryBreadcrumbs({ categoryNames }: { categoryNames: string[] }) {
  ...
  return (
    <div className="text-sm text-gray-500 mb-3 lg:mb-6 flex items-center gap-2 flex-wrap">
      <Link prefetch={true} href="/" className="hover:underline flex items-center gap-1 text-black font-medium">
        ...
        return (
          <React.Fragment key={href}>
            ...
            {isLast ? (
              ...
              <Link prefetch={true} href={href} className="hover:underline hover:text-black">
                {name}
              </Link>
            )}
          </React.Fragment>
